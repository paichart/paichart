...
| [`pov-program`](pov-program-protocol.md) | 1.5.0 | Programs of pipelines: the DAG, the interface contract, the plan gate, the release gate's deterministic AND | The most-verified text here — VT-01…VT-14 exercise it, including the failure rounds |
