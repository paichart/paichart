...
The two guards the fixtures targeted both did their job: **the secret-shaped tag was redacted, and the injection was recognized and refused** — the layered defense, shown rather than asserted. (Run: harness execution `cmqyox1oh…`, 126s, self-provisioned service torn down at SYNTHESIZE.)
