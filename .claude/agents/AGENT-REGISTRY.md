...
| execution-facts-specialist | 🧾 | Fact PRODUCTION on executions — the mechanical nets (derivation-containment, dialect-lint, marker-presence, the scheduled rollbackContainment), their enrichment modules, fact stamping + the RESULT_JSON_SUMMARY_KEYS whitelist (E3b nesting law), disposition taxonomies, lean-card fact surfacing, replay runners, incident fixtures, the shared net registry (unbuilt), and the corpus-measure-before-building practice | Created 2026-09-11 by SPECIALIST-LIFECYCLE-GUIDE §3b SPLIT from pipeline-harness-specialist (parent 513 lines, over the Protocol-12 soft budget; producer/consumer seam on execution facts; load recurring — net #3 trigger fired 2026-09-10 with three fixtures, registry extraction, H-4 coordination). Measured at creation: 4 facts wired, ONE hand-wired call site in execution-core.ts, 0 registry, 3 replay runners. Open: dialectLint + contractPropagation render on NO lean-card line | Read, Edit, Write, Grep, Glob, Bash | 2026-09-11 | execution-facts-discovery.md |
