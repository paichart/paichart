...
| 5 | A derivation **arithmetic error** (an aggregate that didn't cover its own members) — caught by the leg reviewer | The `member-not-covered` mechanical violation class |
